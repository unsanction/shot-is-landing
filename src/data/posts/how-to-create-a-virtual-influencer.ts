...
export const post: BlogPost = {
  ...
  metaTitle: 'How to Create a Virtual Influencer | SHOT.IS',
  description:
    'Create a virtual influencer step by step: positioning, locking a canonical identity, the content system, reference-anchored production, and QA.',
  excerpt:
  ...
  tldr: [
    ...
    'Plan disclosure before launch, because several markets legally require saying the character is not a real person.',
  ],
  blocks: [
    {
      type: 'p',
    ...
    },
    {
      ...
      items: [
        ...
        'Genre and lane: fashion, fitness, tech, or food. Pick one lane and hold it.',
    ...
    },
    {
      type: 'h2',
      id: 'identity-lock',
      text: 'Step 2. Lock the identity with a canonical reference set',
    },
    {
      type: 'p',
    ...
    },
    {
      ...
      items: [
        ...
        'World: where this character lives and shoots, covering locations, palette, and lens feel.',
    ...
    },
    {
      ...
      body: 'Every character on the SHOT.IS roster, including VEXA-9, KAI_OS, and LUNA_CORE, exists as a canonical identity set first and content second. When a generation drifts from the set, we reject the output, however good it looks in isolation.',
    },
    {
      type: 'h2',
      id: 'content-system',
      text: 'Step 3. Design the content system rather than individual posts',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'Reference-anchored generation means every image and video starts from the canonical identity set rather than a text prompt describing the character. Text descriptions drift; references hold. For video, we generate keyframes first and animate them second, so the keyframe carries the identity and the video model inherits it. The [keyframe-to-video workflow](/blog/keyframe-to-video-workflow) post covers those mechanics.',
    },
    {
      type: 'h2',
      id: 'qa',
    ...
    {
      type: 'p',
      text: 'Identity QA compares every generated asset to the canonical set before it ships: same face, same styling constants, same world. We machine-grade this because human reviewers stop noticing gradual drift, where each output looks “close enough” to the previous one while the character becomes someone else. [AI character consistency](/blog/ai-character-consistency) tells the full engineering story.',
    },
    {
      type: 'h2',
      id: 'launch',
    ...
    {
      type: 'p',
      text: 'Before the first post goes live, decide how the character discloses that it is AI. Several markets, including the US and India, require saying the influencer is not a real person, and platform-level AI labels are becoming standard. Confident disclosure reads as a feature rather than a confession, and the most successful virtual influencers are openly virtual.',
    },
    {
      type: 'h2',
      id: 'mistakes',
    ...
    },
    {
      type: 'ul',
      items: [
        'No identity lock, so you regenerate the character from a text prompt each time. It drifts within days.',
        'Portrait thinking: a beautiful character with no formats, no lane, and nothing to say.',
        'Skipping QA and trusting that outputs “look right”. Drift stays gradual and invisible until it is embarrassing.',
        'Hidden AI, where you pretend the character is human. Audiences forgive virtual; they do not forgive deceptive.',
        'One-campaign thinking, which treats the character as a stunt instead of an asset that compounds.',
      ],
    },
    {
      type: 'p',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'In several markets, yes, including the US and India. Sponsored content must be labeled as advertising everywhere, and openly-virtual positioning outperforms hidden AI anyway.',
    },
  ],
};
